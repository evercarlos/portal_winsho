    ...
    <div class="contenedor_header">
        <nav class="cbp-hsmenu-wrapper" id="cbp-hsmenu-wrapper">
            <div class="cbp-hsinner">
                <div class="logo">
                    <a href="index.php">
                        <img src="images/logo.jpg" style="width: 35%" alt="">
                    </a>
                </div>
                    ...
                    <section class="noticia" data-aos="fade-up" data-aos-duration="1300">
                        <div class="container">
                            <div class="row">
                                ...
                                <!-- YOU TUBE -->
                                <div class="col-lg-4 col-md-6 text-center border rounded py-4">
                                    <a href="javascript:void(0)" id="b_customer" class="fa fa-4x fa-file-archive"></a>
        ...
        <div class=""><!-- container-->
            <div class="table-responsive">
                <table class="table table-bordered table-hover ">
                    ...
                    <tr>
                        <th class="text-center"><a href="http://www.minem.gob.pe/" class="tran3s" target="_blank"><img
...
<script src="js/global6197.js?V=1.2"></script><!-- MENU-->
